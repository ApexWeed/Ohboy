...
jokes = ["How can sea captains use amphibians? As froghorns.",
...
"What do you call a pirate with a peg leg on ice? A protractor.",
"somedood"]

@sopel.module.commands('dadjoke', 'badjoke')
def dad(bot, trigger):
